...
async function buscarTarefas() {
    ...
    try {
        ...
        listaTarefas.innerHTML = '<p class="text-red-400 text-sm">Erro ao carregar. JSON Server rodando?</p>';
    }
}
...
async function adicionarTarefa(event) {
    ...
    // Salva com o usuarioId
    await fetch(URL_TAREFAS, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ titulo, concluida: false, usuarioId: usuario.id })
    });
